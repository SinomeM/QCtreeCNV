...
![QCtreeCNVpipeline](./QCtreeCNV_pipeline.png){width=100%}

![Decision making filtering tree](./QCtree.png){width=80%}

## Details

Some details on each step, the numbering follows the one in the
previous figure:
